            ...
            <details class="review-details-toggle">
              ...
              <div class="review-expand-card">
                <div class="review-expand-grid">
                  <div><strong>المندوب</strong>${escapeHtml(String(data.assignedDriverId || data.offeredDriverId || 'غير معين'))}</div>
  ...
  operationsOrderDetails.innerHTML = `
    <div class="order-detail-shell">
      ...
      <div class="order-detail-grid">
        <div class="order-detail-card"><strong>العميل</strong>${escapeHtml(data.clientName || data.clientId || '-')}<br />${escapeHtml(data.clientPhone || '-')}</div>
        <div class="order-detail-card"><strong>المتجر</strong>${escapeHtml(data.restaurantName || data.restaurantId || '-')}</div>
        <div class="order-detail-card"><strong>المندوب الحالي</strong>${escapeHtml(data.assignedDriverId || data.offeredDriverId || 'غير معين')}</div>
