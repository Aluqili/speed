...
class AppThemeArabic {
  ...
  static ThemeData _buildClientTheme({Color? seed, bool dark = false}) {
    ...
    final scheme = ColorScheme(
      ...
      primaryContainer:
          dark ? const Color(0xFF7A1000) : const Color(0xFFFFE0DC),
      onPrimaryContainer:
          dark ? const Color(0xFFFFE0DC) : const Color(0xFF5A0A00),
      secondary: dark ? const Color(0xFFFFCA7A) : clientAccent,
      onSecondary: dark ? const Color(0xFF5A3000) : Colors.white,
      secondaryContainer:
          dark ? const Color(0xFF5A3000) : const Color(0xFFFFF0D0),
      onSecondaryContainer:
          dark ? const Color(0xFFFFF0D0) : const Color(0xFF5A3000),
      tertiary: dark ? const Color(0xFF80CBC4) : const Color(0xFF1A9644),
      onTertiary: Colors.white,
      tertiaryContainer:
          dark ? const Color(0xFF003D36) : const Color(0xFFD4F0DC),
      onTertiaryContainer:
          dark ? const Color(0xFFB2DFDB) : const Color(0xFF0A4020),
      error: dark ? const Color(0xFFFF6E6E) : clientError,
      onError: Colors.white,
      errorContainer: dark ? const Color(0xFF8B0000) : const Color(0xFFFFEBEB),
      onErrorContainer:
          dark ? const Color(0xFFFFCDD2) : const Color(0xFF7F0000),
      surface: dark ? const Color(0xFF1C1209) : clientSurface,
      onSurface: dark ? const Color(0xFFF5EDE8) : clientTextPrimary,
      surfaceContainerHighest:
          dark ? const Color(0xFF2E1005) : const Color(0xFFF0EBE1),
      ...
      onInverseSurface:
          dark ? const Color(0xFF1C110A) : const Color(0xFFF8F4EE),
    ...
    return base.copyWith(
      ...
      scaffoldBackgroundColor:
          dark ? const Color(0xFF000000) : clientBackground,
      textTheme: textTheme,
      ...
      chipTheme: ChipThemeData(
        ...
        disabledColor: dark ? const Color(0xFF2E1005) : const Color(0xFFF8F4EE),
        labelStyle: TextStyle(
          fontFamily: fontFamily,
          fontWeight: FontWeight.w600,
          fontSize: 13,
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        backgroundColor:
            dark ? const Color(0xFF2C2C2E) : const Color(0xFF1C1C1E),
        contentTextStyle: TextStyle(
          fontFamily: fontFamily,
          fontWeight: FontWeight.w500,
          fontSize: 14,
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        unselectedItemColor:
            dark ? const Color(0xFF636366) : const Color(0xFF8E8E93),
  ...
  static ThemeData storeFromSeed(Color seed, {bool dark = false}) =>
      _buildStoreTheme(seed: seed, dark: dark);

  static ThemeData _buildStoreTheme({Color? seed, bool dark = false}) {
    final primary = seed ?? storePrimary;
    final scheme = ColorScheme.fromSeed(
      seedColor: primary,
