...
لا يمكن إخراج IPA موقّع نهائيًا من Windows مباشرة. يلزم Mac فعلي أو CI على macOS (مثل Codemagic/GitHub Actions macOS runner).
...
- Signing/Team/Profiles مضبوطة
- اختبار تسجيل الدخول/الخرائط/الإشعارات/رفع الصور على iPhone حقيقي
