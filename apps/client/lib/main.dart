  ...
  Future<void> _safeInit() async {
    ...
    try {
      ...
      final defaults = <String, Object>{
        ...
        'client_home_show_offers_section': true,
        'client_home_show_categories_section': true,
        'client_home_show_restaurants_section': true,
        'client_home_nav_accent_hex': 'E85D2A',
        'client_delivery_time_mode': 'hybrid',
        'client_delivery_time_show_route_minutes': false,
